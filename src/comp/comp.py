...
print("Starts with D:")
a = [("%s"%human.name) for human in humans if human.name[0] =='D']
print(a)
...
e = [("%s%s%d" %(human.name,'-',human.age)) for human in humans]
print(e)
...
# f = [("%s%s %d" %(human.name,',',human.age)) for human in humans if human.age >=27 and human.age <=32]
